...
class Address
{
    ...
    private function registerNewAddress()
    {
        ...
        elseif (!empty($_POST['name']) || !empty($_POST['first_name']) || !empty($_POST['email']) || !empty($_POST['street']) || !empty($_POST['zipcode']) || !empty($_POST['city']))
        {
                ...
                ->connect_errno)
            {
                ...
                $name = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['name'], ENT_QUOTES));
                $first_name = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['first_name'], ENT_QUOTES));
                $email = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['email'], ENT_QUOTES));
                $street = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['street'], ENT_QUOTES));
                $zipcode = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['zipcode'], ENT_QUOTES));
                $city = $this
                    ->db_connection
                    ->real_escape_string(strip_tags($_POST['city'], ENT_QUOTES));
    ...
    public function exportToJson()
    {
        ...
        $sql = "SELECT * FROM addresses";
        $query_fetch_addresses = $this
            ->db_connection
            ->query($sql);

        $allAddresses = $query_fetch_addresses->fetch_all(MYSQLI_ASSOC);
